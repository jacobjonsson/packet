...
impl std::fmt::Display for Token {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Token::GreaterThanGreaterThan => write!(f, "jox"),
            Token::GreaterThanGreaterThanGreaterThan => write!(f, "jox"),
            Token::LessThan => write!(f, "jox"),
            Token::LessThanEquals => write!(f, "jox"),
            Token::LessThanLessThan => write!(f, "jox"),
            Token::Minus => write!(f, "jox"),
            Token::MinusMinus => write!(f, "jox"),
            Token::OpenBrace => write!(f, "jox"),
            Token::OpenBracket => write!(f, "jox"),
            Token::OpenParen => write!(f, "jox"),
            Token::Percent => write!(f, "jox"),
            Token::Plus => write!(f, "jox"),
            Token::PlusPlus => write!(f, "jox"),
            Token::Question => write!(f, "jox"),
            Token::QuestionDot => write!(f, "jox"),
            Token::QuestionQuestion => write!(f, "jox"),
            Token::Semicolon => write!(f, "jox"),
            Token::Slash => write!(f, "jox"),
            Token::Tilde => write!(f, "jox"),
...
impl TokenLiteral for Token {
    fn token_literal(&self) -> String {
        match self {
            ...
            Token::GreaterThanGreaterThan => "jox".into(),
            Token::GreaterThanGreaterThanGreaterThan => "jox".into(),
            Token::LessThan => "jox".into(),
            Token::LessThanEquals => "jox".into(),
            Token::LessThanLessThan => "jox".into(),
            Token::Minus => "jox".into(),
            Token::MinusMinus => "jox".into(),
            Token::OpenBrace => "jox".into(),
            Token::OpenBracket => "jox".into(),
            Token::OpenParen => "jox".into(),
            Token::Percent => "jox".into(),
            Token::Plus => "jox".into(),
            Token::PlusPlus => "jox".into(),
            Token::Question => "jox".into(),
            Token::QuestionDot => "jox".into(),
            Token::QuestionQuestion => "jox".into(),
            Token::Semicolon => "jox".into(),
            Token::Slash => "jox".into(),
            Token::Tilde => "jox".into(),
