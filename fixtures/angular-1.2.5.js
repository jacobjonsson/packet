 ...
 */
    ...
    if (isNaN(msie)) {
        msie = int(
            (/trident\/.*; rv:(\d+)/.exec(lowercase(navigator.userAgent)) ||
                [])[1]
        );
    }
  ...
  */
    ...
    function bootstrap(element, modules) {
        var doBootstrap = function () {
            ...
            if (element.injector()) {
                var tag =
                    element[0] === document ? "document" : startingTag(element);
                throw ngMinErr(
                    "btstrpd",
            ...
            attr: function (element, name, value) {
                ...
                if (BOOLEAN_ATTR[lowercasedName]) {
                    if (isDefined(value)) {
                        ...
                        return element[name] ||
                            (element.attributes.getNamedItem(name) || noop)
                                .specified
                            ? lowercasedName
                            : undefined;
                    }
        ...
        this.$get = function () {
            ...
            function cacheFactory(cacheId, options) {
                ...
                var size = 0,
                    ...
                    data = {},
                    capacity =
                        (options && options.capacity) || Number.MAX_VALUE,
                    lruHash = {},
                    freshEnd = null,
                    staleEnd = null;
                ...
                return (caches[cacheId] = {
                    put: function (key, value) {
                        var lruEntry =
                            lruHash[key] || (lruHash[key] = { key: key });
            ...
            function (
                ...
                Attributes.prototype = {
                    ...
                    $updateClass: function (newClasses, oldClasses) {
                        this.$removeClass(
                            tokenDifference(oldClasses, newClasses)
                        );
                    ...
                    switch (nodeType) {
                        case 1 /* Element */:
                            ...
                            if (isString(className) && className !== "") {
                                while (
                                    (match = CLASS_DIRECTIVE_REGEXP.exec(
                                        className
                                    ))
                                ) {
                ...
                function buildUrl(url, params) {
                    ...
                    forEachSorted(params, function (value, key) {
                        ...
                        forEach(value, function (v) {
                            ...
                            parts.push(
                                encodeUriQuery(key) + "=" + encodeUriQuery(v)
                            );
                        });
                    });
                    return (
                ...
                function $interpolate(
                    ...
                    if (!mustHaveExpression || hasInterpolation) {
                        ...
                        fn = function (context) {
                            try {
                                for (
                                    var i = 0, ii = length, part;
                                    i < ii;
                                    i++
                                ) {
                                    if (
                                        typeof (part = parts[i]) == "function"
                                    ) {
                                        part = part(context);
                                        if (trustedContext) {
                                            part = $sce.getTrusted(
    ...
    function LocationHtml5Url(appBase, basePrefix) {
        ...
        this.$$rewrite = function (url) {
            ...
            if ((appUrl = beginsWith(appBase, url)) !== undefined) {
                ...
                (appUrl = beginsWith(appBaseNoFile, url)) !== undefined
            ) {
                ...
                function formatError(arg) {
                    if (arg instanceof Error) {
                        if (arg.stack) {
                            arg =
                                arg.message &&
                                arg.stack.indexOf(arg.message) === -1
                                    ? "Error: " + arg.message + "\n" + arg.stack
                                    : arg.stack;
    ...
    Parser.prototype = {
        ...
        ternaryFn: function (left, middle, right) {
            return extend(
                ...
                {
                    constant:
                        left.constant && middle.constant && right.constant,
                }
            );
        },
    ...
    function cspSafeGetterFn(key0, key1, key2, key3, key4, fullExp, options) {
        ...
        return !options.unwrapPromises
            ...
            : function cspSafePromiseEnabledGetter(scope, locals) {
                  var pathVal =
                          locals && locals.hasOwnProperty(key0)
                              ? locals
                              : scope,
                      promise;
      ...
      */
        ...
        */
                    ...
                    $on: function (name, listener) {
                        ...
                        return function () {
                            namedListeners[
                                indexOf(namedListeners, listener)
                            ] = null;
                        };
                    },
        ...
        return {
            ...
            link: function (scope, element, attr, ctrl) {
                var match = /\/(.*)\//.exec(attr.ngList),
                    separator =
                        (match && new RegExp(match[1])) || attr.ngList || ",";
            ...
            return {
                ...
                link: function (scope, element, attr) {
                    var numberExp = attr.count,
                        whenExp =
                            attr.$attr.when && element.attr(attr.$attr.when), // we have {{}} in attrs
                        ...
                        function ngRepeatAction(collection) {
                            ...
                            for (index = 0; index < length; index++) {
                                ...
                                if (lastBlockMap.hasOwnProperty(trackById)) {
                                    ...
                                    nextBlockMap.hasOwnProperty(trackById)
                                ) {
